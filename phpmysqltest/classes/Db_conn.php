...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'rphill';//this will be your WCC username
      $dbUsr = 'rphill';//this will be your WCC username
      $dbPass = 'HOZIqR6ns8excWd';//this will be the password found in the video.
